	...
	return (
		<div id={product.productId} className="w-[200px] m-0-auto relative">
			<div
				...
				className=" p-[10px] shadow bg-white flex justify-between w-full rounded-full mt-2 h-10 items-center cursor-pointer "
				onClick={(e) => {
					setDropdown(!dropdown);
				}}
			>
				...
				<div className="absolute p-[5px] shadow mt-0.5 text-sm w-full z-10 bg-white">
					{lists.map((list) =>
						list.productsId.includes(product.productId) ? (
							<div
								className="hover:bg-gray-light cursor-pointer flex justify-between p-1 border-b border-gray-light "
								id="disabled"
								onClick={(e) => {
									handleClick(e);
								}}
							...
							<div
								className="hover:bg-gray-light cursor-pointer p-1 border-b border-gray-light  "
								id={list.docId}
								onClick={(e) => {
									handleClick(e);
								}}
					...
					<div
						className="hover:bg-gray-light cursor-pointer mt-2 text-center "
						id="crear"
						onClick={(e) => {
							handleClick(e);
						}}
